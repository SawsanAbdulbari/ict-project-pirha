  ...
  const getRelevantSections = () => {
    ...
    sections.push({
      ...
      reason: userProfile.lifestyle.includes('low_activity') ? 
        'Vähäinen liikunta - erityisen tärkeä' : 'Fyysinen kunto on tärkeää toipumiselle'
    });
    ...
    sections.push({
      ...
      icon: Heart,
      priority: 'normal',
      reason: 'Hyvä ravitsemus tukee toipumista'
    });
    ...
    sections.push({
      ...
      reason: userProfile.healthConditions.includes('mental_health') ? 
        'Mielenterveyden tuki tärkeää' : 'Henkinen valmistautuminen auttaa'
    });
    ...
    if (userProfile.lifestyle.includes('smoking') || userProfile.lifestyle.includes('alcohol')) {
      sections.push({
        ...
        reason: userProfile.lifestyle.includes('smoking') ? 
          'Tupakoinnin lopettaminen kriittistä' : 'Alkoholin vähentäminen tärkeää'
      });
    }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <div className="flex items-center mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Henkilökohtaiset suosituksesi</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
              ...
              {userProfile.lifestyle.length > 0 && (
                <div className="md:col-span-2">
                  <span className="font-medium">Elämäntavat:</span>{" "}
        ...
        {recommendations.priority.length > 0 && (
          <div className="bg-red-50 border border-red-200 rounded-lg p-6 mb-6">
            <h2 className="text-xl font-semibold mb-4 text-red-900">
              🎯 Prioriteettisuositukset - Keskity näihin ensin
            </h2>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          {recommendations.exercise.length > 0 && (
            <div className="mb-4">
              <h3 className="font-semibold text-blue-800 mb-2">💪 Liikunta</h3>
          ...
          {recommendations.nutrition.length > 0 && (
            <div className="mb-4">
              <h3 className="font-semibold text-green-800 mb-2">🍎 Ravitsemus</h3>
              <ul className="space-y-1 text-sm text-gray-700">
          ...
          {recommendations.lifestyle.length > 0 && (
            <div className="mb-4">
              <h3 className="font-semibold text-purple-800 mb-2">🌟 Elämäntavat</h3>
              <ul className="space-y-1 text-sm text-gray-700">
          ...
          {recommendations.medical.length > 0 && (
            <div className="mb-4">
              <h3 className="font-semibold text-red-800 mb-2">⚕️ Lääketieteelliset</h3>
              <ul className="space-y-1 text-sm text-gray-700">
        ...
        <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg shadow-md p-6 text-white">
          ...
          <ol className="space-y-2 mb-4">
            <li>1. Käy läpi prioriteettisuositukset</li>
            <li>2. Tutustu sinulle tärkeimpiin sisältöihin</li>
            <li>3. Lataa henkilökohtaiset PDF-oppaat</li>
